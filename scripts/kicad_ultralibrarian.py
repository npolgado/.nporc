...
project_name = str(input("Please enter a name for your project: "))

# Unzip the zip file and find the .lib file and folder with .pretty in the name
...
for root, dirs, files in os.walk(tmp_folder):
    for file in files:
        if file.endswith(".lib"):
            ...
            # Rename .lib file and .pretty folder with project name
...
# Copy .lib file to SYMBOL_PATH and move .pretty folder to FOOTPRINT_PATH
